...
def test_copy_chm_supports_directory_destination(
    ...
    assert compile_chm_module.copy_chm(source, f"{destination}{os.sep}") is True
    assert (destination / source.name).read_bytes() == b"chm"
