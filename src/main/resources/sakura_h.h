...
EXTERN_C const IID IID_ITrayWnd;
    ...
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE ShowTrayClickMenu( void) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE ShowTrayContextMenu( void) = 0;
    ...
    typedef struct ITrayWndVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ITrayWnd, ShowTrayClickMenu)
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *ShowTrayClickMenu )( 
            ITrayWnd * This);
        
        DECLSPEC_XFGVIRT(ITrayWnd, ShowTrayContextMenu)
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *ShowTrayContextMenu )( 
            ITrayWnd * This);
...
#define ITrayWnd_ShowTrayClickMenu(This)	\
    ( (This)->lpVtbl -> ShowTrayClickMenu(This) ) 

#define ITrayWnd_ShowTrayContextMenu(This)	\
    ( (This)->lpVtbl -> ShowTrayContextMenu(This) ) 
