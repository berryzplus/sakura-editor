...
{
	const auto hLangRsrcInstance = HINSTANCE(static_cast<size_t>(0x1234));
...
{
	const auto hLangRsrcInstance = HINSTANCE(static_cast<size_t>(0x1234));
	const auto hResInfo          = HRSRC(static_cast<size_t>(0x5678));
...
TEST(CopyResource, LockResource_fail)
{
	const auto hLangRsrcInstance = HINSTANCE(static_cast<size_t>(0x1234));
	const auto hResInfo          = HRSRC(static_cast<size_t>(0x5678));
	const auto hResData          = HGLOBAL(static_cast<size_t>(0x8765));
