...
namespace WCODE {
	...
	public:
		...
		void Select( ECharWidthFontMode fMode, ECharWidthCacheMode cMode, const ShareDataAccessor& _ShareDataAccessor = ::GetShareDataAccessor() )
		{
...
void SelectCharWidthCache( ECharWidthFontMode fMode, ECharWidthCacheMode cMode, const ShareDataAccessor& _ShareDataAccessor )
{
