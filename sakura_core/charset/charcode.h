...
// キャッシュの初期化関数群
void SelectCharWidthCache( ECharWidthFontMode fMode, ECharWidthCacheMode cMode, const ShareDataAccessor& _ShareDataAccessor = ::GetShareDataAccessor() );  //!< モードを変更したいとき
