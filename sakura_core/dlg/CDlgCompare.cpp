...
//	setlocale ( LC_ALL, "C" );
	...
	nRowNum = CAppNodeManager::getInstance()->GetOpenedWindowArr( &pEditNodeArr, TRUE, FALSE, GetShareDataAccessor() );
	if( nRowNum > 0 ){
 ...
 */
void CDlgCompare::OnWndSize(HWND hDlg, UINT state, int cx, int cy)
{
 ...
 */
void CDlgCompare::OnGetMinMaxInfo(HWND hDlg, _In_ LPMINMAXINFO lpMinMaxInfo)
{
