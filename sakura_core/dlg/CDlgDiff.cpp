...
CDlgDiff::CDlgDiff(const ShareDataAccessor& ShareDataAccessor_)
	: CSizeRestorableDialog(IDD_DIFF, ShareDataAccessor_)
	, m_nIndexSave( 0 )
{
...
{
	auto& rcDialog  = GetShareData()->m_Common.m_sOthers.m_rcDiffDialog;
