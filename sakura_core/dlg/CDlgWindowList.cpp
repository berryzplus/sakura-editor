...
CDlgWindowList::CDlgWindowList(const ShareDataAccessor& ShareDataAccessor_)
	: CSizeRestorableDialog(IDD_WINLIST, ShareDataAccessor_)
{
 ...
 */
void CDlgWindowList::OnWndSize(HWND hDlg, UINT state, int cx, int cy)
{
