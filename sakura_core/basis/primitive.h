...
public:
	...
	bool c_str_uses_buffer() const noexcept
	{
		return !m_RawPtr && !m_Buffer.empty();
	}
	...
	{
		return m_RawPtr ? m_Length : m_Buffer.length();
	}
