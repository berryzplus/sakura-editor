...
//	Jun. 26, 2001 genta
//!	正規表現ライブラリのバージョン取得
bool CheckRegexpVersion( HWND hWnd, int nCmpId, bool bShowMsg = false, const ShareDataAccessor& _ShareDataAccessor = ::GetShareDataAccessor() );
...
bool InitRegexp( HWND hWnd, CBregexp& rRegexp, bool bShowMessage, const ShareDataAccessor& _ShareDataAccessor = ::GetShareDataAccessor() );
